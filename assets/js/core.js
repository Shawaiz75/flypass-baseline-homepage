...
sizeAdvMedia();
addEventListener('resize', sizeAdvMedia);
addEventListener('load', sizeAdvMedia);
/* RATIO-SETTLE: re-run after fonts and late reflows so the ratio holds exactly. */
(function () {
  if (document.fonts && document.fonts.ready) document.fonts.ready.then(sizeAdvMedia);
  setTimeout(sizeAdvMedia, 1200); setTimeout(sizeAdvMedia, 3000);
})();
